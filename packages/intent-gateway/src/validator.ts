...
import { IntentionContract, DOMAINS, ValidationError } from './types.js';
...
export function validateIntentionContract(contract: unknown): ValidationResult {
  ...
  } else if (!VALID_DOMAINS.includes(c.domain as typeof DOMAINS[keyof typeof DOMAINS])) {
    errors.push({
      field: 'domain',
